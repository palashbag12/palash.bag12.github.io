...
<form action="search_caste.php" method="post">
...
<th> Caste
<td><input type="checkbox" name="check_list1[]" value="UR"><label>UR</label><br/>
<td><input type="checkbox" name="check_list1[]" value="SC"><label>SC</label><br/>
<td><input type="checkbox" name="check_list1[]" value="ST"><label>ST</label><br/>
<td><input type="checkbox" name="check_list1[]" value="OBC"><label>OBC</label><br/>
</th>
